...
1. CREATE array based on credentials.txt
 	-Additional values may be added directly to code
2.DISPLAY usage information for user
	-PROMPT for username
3. IF user enters quit, exit program
	-PROMPT for password
	-IF user enters quit, exit program
4.LOOP for no more than 3 user authentication attempts
